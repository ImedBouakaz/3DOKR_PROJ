...
- **Ajouter la source de données Prometheus (dans l'onglet `Data Source`)** : `http://192.168.99.100:9090`
- **Importer des dashboards** : Utilisez ceux proposés par Grafana ou bien des dashboards personnalisés comme celui proposé dans le projet : `/dashboard/docker-dashboard.json`. (Pensez bien à sélectionner la data source prometheus au moment de l'importation).
